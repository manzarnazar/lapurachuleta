...
class NotificationController extends Controller
{
     ...
     *
     * - Seller panel  → scoped to the seller's `notifiable_id`.
     * - Admin panel   → scoped to `data->sent_to = 'admin'` (no user scope).
     */
    public function markAllAsRead(): JsonResponse
    {
        try {
            ...
            if ($this->getPanel() === 'seller') {
                ...
                // Admin panel: mark all admin-targeted notifications as read.
                $count = Notification::sentTo('admin')
                    ->whereNull('read_at')
                    ->count();
    ...
    public function getNotifications(Request $request): JsonResponse
    {
        try {
            ...
            if ($this->getPanel() === 'admin') {
                ...
                // Only notifications belonging to this seller's user account.
                $userId = $this->sellerUserId;

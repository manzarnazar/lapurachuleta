...
class SellerDashboardApiController extends Controller
{
    ...
    public function overview(Request $request): JsonResponse
    {
        ...
        // NOTE: DashboardService methods currently aggregate by seller only; extend there if store-level stats are needed.
        $productStats = $this->dashboardService->getProductStats($sellerId);
        $salesStats = $this->dashboardService->getSalesData($sellerId);
